...
int whichRegion(const T& h, const T& theta) {
	...
	if (IN_BETA19(config::d,h,theta)) 
	    return 19; 

    if (IN_G0(config::d,h,theta)) {
	if (config::widthSelection == 0) {
	    if (IN_BETA0(config::d,h,theta)) { return 0; } 
	    else if (IN_BETA1(config::d,h,theta)) { return 1; }
	    else if (IN_BETA2(config::d,h,theta)) { return 2; }
	    else if (IN_BETA3(config::d,h,theta)) { return 3; }
	    else if (IN_BETA4(config::d,h,theta)) { return 4; }
	    else if (IN_BETA5(config::d,h,theta)) { return 5; }
	    else if (IN_BETA6(config::d,h,theta)) { return 6; }
	    else if (IN_BETA7(config::d,h,theta)) { return 7; }
	    else if (IN_BETA8(config::d,h,theta)) { return 8; }
	    else if (IN_BETA9(config::d,h,theta)) { return 9; }
	    else if (IN_BETA10(config::d,h,theta)) { return 10; }
	    else if (IN_BETA11(config::d,h,theta)) { return 11; }
	    else { return -1; }
	} else {
	    if (IN_BETA0(config::d,h,theta)) { return 0; } 
	    else if (IN_ZJ0(config::d,h,theta)) { return 4; }
	    else if (IN_ZJ1(config::d,h,theta)) { return 5; }
	    else if (IN_ZJ2(config::d,h,theta)) { return 6; }
	    else if (IN_ZJ3(config::d,h,theta)) { return 8; }
	    else if (IN_ZJ4(config::d,h,theta)) { return 9; }
	    else if (IN_ZJ5(config::d,h,theta)) { return 10; }
	    else if (IN_ZJ6(config::d,h,theta)) { return 11; }
	    else { return -1; }
	}
    } else if (IN_G2(config::d,h,theta)) {
	if (IN_BETA12(config::d,h,theta)) { return 12; }
    	else if (IN_BETA13(config::d,h,theta)) { return 13; }
    	else if (IN_BETA14(config::d,h,theta)) { return 14; }
    	else if (IN_BETA15(config::d,h,theta)) { return 15; }
    	else { return -1; }
    } else if (IN_G3(config::d,h,theta)) {
	if (IN_BETA16(config::d,h,theta)) { return 16; }
    	else if (IN_BETA17(config::d,h,theta)) { return 17; }
    	else if (IN_BETA18(config::d,h,theta)) { return 18; }
    	else { return -1; }
    } else { return -1; }
}
